// components/receptionist/ReceptionistSidebar.tsx
"use client";
...
const navItems = [
    ...
    { title: 'Clients',              href: '/receptionist/clients',          icon: User            },
    { title: 'Sittings Registration',href: '/receptionist/sittings-register',icon: CalendarPlus    },
    { title: 'Service Orders',       href: '/receptionist/service-orders',   icon: ClipboardList   },
    { title: 'Billing & Payments',   href: '/receptionist/billing-payments', icon: CreditCard      },
    { title: 'Delivery Status',      href: '/receptionist/delivery',         icon: Truck           },
    { title: 'Inventory',            href: '/receptionist/inventory-view',   icon: Package         },
    { title: 'Event Calendar',       href: '/receptionist/event-calendar',   icon: CalendarDays    },
];
