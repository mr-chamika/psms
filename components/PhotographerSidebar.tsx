// components/photographer/PhotographerSidebar.tsx
"use client";
...
const navItems = [
    { title: 'Dashboard',             href: '/photographer',        icon: LayoutDashboard },
    { title: 'My Sittings',           href: '/photographer/my-sittings',         icon: Camera          },
    { title: 'Upload Raw Photos',     href: '/photographer/upload-photos',       icon: Upload          },
    { title: 'Equipment Availability',href: '/photographer/equipment-status',    icon: Aperture        },
];
        ...
        >
            ...
            <nav className="flex-1 overflow-y-auto py-4 px-3">
                <ul className="space-y-1">
                    {navItems.map((item) => {
                        const isActive = item.href === '/photographer'
                            ? pathname === item.href
